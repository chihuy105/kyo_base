...
/// to the [leading] and [trailing] properties of [AppExpansionTile].
///
/// {@tool dartpad}
...
class AppExpansionTile extends StatefulWidget {
  ...
  const AppExpansionTile({
    ...
    this.controlAffinity, this.visualDensity,
...
class AppExpansionTileState extends State<AppExpansionTile> with SingleTickerProviderStateMixin {
  ...
  void expand({bool callOnChange = true}) {
    _setExpanded(true, callOnChange: callOnChange);
  }

  void collapse({bool callOnChange = true}) {
    _setExpanded(false, callOnChange: callOnChange);
  }

  void toggle({bool callOnChange = true}) {
    _setExpanded(!_isExpanded, callOnChange: callOnChange);
  }

  void _setExpanded(bool isExpanded, {bool callOnChange = true}) {
    if (_isExpanded != isExpanded) {
      ...
      if (widget.onExpansionChanged != null && callOnChange) {
